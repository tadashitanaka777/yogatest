		...
		e1.preventDefault();
			...
			if(boxUl.css("left")!=-termina+"px"){
				...
				complete: function() {
					...
					//frecce
					if(boxUl.position().left== 0){$(this).parents(".site_block").find(".site_slider-left").hide();}
					else{$(this).parents(".site_block").find('.site_slider-left').show();}
					active = false; */
		...
		function pallini( p )
		 {
		 	//muovi
							...
							//frecce
							if(boxUl.position().left== 0){$( p ).parents(".site_block").find(".site_slider-left").hide();}
							else{$( p ).parents(".site_block").find('.site_slider-left').show();}
							active = false;
		 }  
