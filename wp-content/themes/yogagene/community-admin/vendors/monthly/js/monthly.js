...
(function ($) {
	...
	$.fn.extend({
		...
		function setMonthly(month, year) {
			...
			for(var dayNumber = 1; dayNumber <= dayQty; dayNumber++) {
				...
				if(options.mode === "event") {
					...
					$(parent + " .monthly-day-wrap").append("<div"
						...
						+ attr("data-date", thisDate.toLocaleDateString("ja-JP").replace(/\//g,'-'))
						+ ">" + innerMarkup + "</div>");
			...
			$(parent + " .monthly-header-title").html('<a href="#" class="monthly-header-title-date" onclick="return false">'+ year + "年" + monthNames[month - 1] + "</a>" + (settingCurrentMonth && $(parent + " .monthly-event-list").hide() ? "" : ''));
