<div id="grandson" class="modal fade bd-calendar-instructor-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div id="modal-calendar-instructor-list">
              <ul class="list-unstyled table-ul list">
                ...
                <li class="table-li">
                  <div class="table-cell table-thumbnail">
                    <img src="/images/instructor/inst-thumb-<?php echo $val['id']; ?>.jpg" class="suck">
                  </div>
                  <div class="table-cell">
                    <h3 class="table-title" data-value="<?php echo $val['name']; ?>"><?php echo $val['name']; ?></h3>
                    <p class="table-description"><span>主な活動エリア</span><?php echo $area; ?></p>
                  </div>
                  <div class="table-cell table-button">
                    <div class="form-group">
                      <button type="submit" class="btn btn-default btn-sm add data-id-<?php echo $val['id']; ?>" data-value="<?php echo $val['id']; ?>">追加</button>
                    </div>
                  </div>
                </li>
                <?php
