<div class="modal fade bd-job-address-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">登録情報検索</h5>
                ...
                <li class="table-li">
                  ...
                  <div class="table-cell table-button">
                    <div class="form-group">
                      <button class="btn btn-default btn-sm no-submit add data-id-<?php echo $val['id']; ?>" data-value="<?php echo $val['id']; ?>">追加</button>
                    </div>
                  </div>
                </li>
                <?php
