<div class="modal fade bd-instructor-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">インストラクター検索</h5>
      ...
      <div class="modal-body">
        ...
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div id="modal-instructor-list">
              <ul class="list-unstyled table-ul list">
                <?php
                  foreach ($dataClass->getinstructor() as $key => $val) :
                ...
                <li class="table-li">
                  <div class="table-cell table-thumbnail">
                    <img src="/images/instructor/inst-thumb-<?php echo $val['id']; ?>.jpg" class="instructor-thumb suck">
                  </div>
                  <div class="table-cell">
                    <h3 class="table-title" data-value="<?php echo $val['name']; ?>"><?php echo $val['name']; ?></h3>
                    <p class="table-description"><span>主な活動エリア</span><span class="instructor-area" data-value="<?php echo $area; ?>"><?php echo $area; ?></span></p>
                  </div>
                  <div class="table-cell table-button">
                    <div class="form-group">
                      <button type="submit" class="btn btn-default btn-sm add data-id-<?php echo $val['id']; ?>" data-value="<?php echo $val['id']; ?>">申請</button>
                    </div>
                  </div>
                </li>
                <?php
